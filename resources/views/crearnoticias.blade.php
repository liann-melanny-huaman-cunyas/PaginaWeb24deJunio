                ...
                <section class="body-font relative text-gray-600">
                    <div class="container mx-auto px-5 py-24">
                      <div class="mb-12 flex w-full flex-col text-center">
                        <h1 class="title-font mb-4 text-2xl font-medium text-gray-900 sm:text-3xl">NOTICIAS</h1>
                      </div>
                        ...
                        <form action="{{ route('noticias.store') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="-m-2 flex flex-wrap">
                              ...
                              <div class="w-full p-2">
                                  <button class="mx-auto flex rounded border-0 bg-black px-8 py-2 text-lg text-white hover:border-2 hover:bg-white hover:text-black focus:outline-none">Cargar noticias</button>
                              </div>
                          </div>
                      </form>
                      </div>

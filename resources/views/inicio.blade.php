...
<body>
  ...
  <section class="bg-black w-42">
    <div class="bg-black px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        <div class="flex">
            <p class="text-sm leading-6 bg-black text-white">
          ...
          <div class="flex flex-wrap md:-m-2 -m-1">
            <div class="flex flex-wrap w-1/2">
              <div class="md:p-2 p-1 w-1/2">
                <img alt="24deJunio" class="w-full object-cover h-full object-center block" src="{{asset('imagenes/portada1.jpeg') }}">
              </div>
              <div class="md:p-2 p-1 w-1/2">
                <img alt="24deJunio" class="w-full object-cover h-full object-center block" src="{{asset('imagenes/portada2.jpeg') }}">
              </div>
              <div class="md:p-2 p-1 w-full">
                <img alt="24deJunio" class="w-full h-full object-cover object-center block" src="{{asset('imagenes/portada3.jpeg') }}">
              </div>
            </div>
            <div class="flex flex-wrap w-1/2">
              <div class="md:p-2 p-1 w-full">
                <img alt="24deJunio" class="w-full h-full object-cover object-center block" src="{{asset('imagenes/portada5.jpeg') }}">
              </div>
              <div class="md:p-2 p-1 w-1/2">
                <img alt="gallery" class="w-full object-cover h-full object-center block" src="{{asset('imagenes/portada7.jpeg') }}">
              </div>
              <div class="md:p-2 p-1 w-1/2">
                <img alt="gallery" class="w-full object-cover h-full object-center block" src="{{asset('imagenes/portada4.jpeg') }}">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="-m-4 flex flex-wrap ">
            <div class="w-44 h-36  p-4  xl:w-72 ">
              <div class="rounded-lg border bg-black p-6 text-center	">
                ...
                <a href="">
                  <div class="mb-4 inline-flex h-10 w-10 items-center mt-5 justify-center rounded-full text-black bg-white hover:bg-black hover:text-white border-black border-2	">
    ...
    <section class="text-black bg-white body-font py-12">
          ...
          <div class="-my-8 divide-y-2 divide-gray-100">
            <div class="py-8 flex flex-wrap md:flex-nowrap">
              ...
              <div class="md:flex flex-wrap">
                ...
                <div class="md:w-2/5">
                    <img alt="content" class="object-cover object-center mt-5 h-full w-full md:-mt-0" src="{{ asset('imagenes/portada4.jpeg') }}">
                </div>
                <div class="md:-mt-12">
              ...
              <div class="md:flex flex-wrap">
                <div class="md:w-3/5">
                  ...
                  <p class="leading-relaxed">La Feria de Comida de este año ha sido más especial que nunca ya que coincidió con el aniversario del colegio; demostrando las habilidades culinarias de los estudiantes</p>
                </div>
                <div class="md:w-2/5">
                    <img alt="content" class="object-cover object-center mt-5 md:-mt-0" src="{{ asset('imagenes/portada3.jpeg') }}">
                </div>
                <div class="md:-mt-12">
                  <a class="text-black inline-flex items-center mt-4">Leer más
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="md:flex flex-wrap">
                <div class="md:w-3/5">
                  <h2 class="text-2xl font-medium text-gray-900 title-font mb-2">Aniversario del colegio</h2>
                  <p class="leading-relaxed"></p>
                </div>
                <div class="md:w-2/5">
                    <img alt="content" class="object-cover object-center mt-5 md:-mt-0" src="{{ asset('imagenes/portada2.jpeg') }}">
                </div>
                <div class="md:-mt-12">
                  <a class="text-black inline-flex items-center mt-4">Leer más
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="p-6 rounded-lg">
                <img class="h-40 rounded w-full object-cover object-center mb-6" src="{{ asset('imagenes/portada3.jpeg') }}" alt="content">
                <h3 class="tracking-widest text-black text-xs font-medium title-font">Publicado el 29 de Junio , 2023 Huancayo </h3>
    ...
    <footer class="bg-white" aria-labelledby="footer-heading">
                ...
                <div class="pl-4 mt-8 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0 ">
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div class="mt-12 md:mt-0">
                            ...
                            <ul role="list" class="mt-4 space-y-4">
                                <li>
                                <a href="#" class="text-sm font-normal text-gray-500 hover:text-gray-900"> Direccion </a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="my-6 sm:flex sm:items-center sm:justify-center">
            <span class="text-sm text-gray-500 sm:text-center">© 2023 <a href="" class="hover:underline">Colegio 24deJunio</a>. All Rights Reserved. </span>
        </div>
    </footer>
</body>
</html>

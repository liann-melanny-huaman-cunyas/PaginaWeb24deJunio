...
<body>
    ...
    <section id="conocenos" class="h-screen flex items-center overflow-hidden">
        <div class="m-20"">
    ...
    <section id="noticias" class="text-black body-font py-12">
        <div class="container">
            <div class="ml-24 flex flex-wrap mb-4">
    ...
    <section id="comunicados" class="comunicados text-gray-600 body-font">

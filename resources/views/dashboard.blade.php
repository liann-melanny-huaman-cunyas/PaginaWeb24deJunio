            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <section class="body-font relative text-gray-600">
                        ...
                        <form action="{{ route('Enviodatos') }}" method="POST" enctype="multipart/form-data">
                            <div class="-m-2 flex flex-wrap">
                              ...
                              <div class="w-1/2 p-2">
                                <div class="relative">
                                  ...
                                  <input type="file" name="pdf" class=" w-full resize-none rounded border border-gray-300 bg-gray-100 bg-opacity-50 px-3 py-1 text-base leading-6 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200"></textarea>
                                </div>
                              </div>
